...
const BRANDS: BrandSeed[] = [
  ...
  // Fill batch 1 — notable additions
  { canonicalName: "Unibic", aliases: ["unibic"], country: "IN" },
  { canonicalName: "Pringles", aliases: ["pringles"], country: "US", parentCompany: "Kellanova" },
  { canonicalName: "Nissin", aliases: ["nissin"], country: "JP", parentCompany: "Nissin Foods" },
  { canonicalName: "Snickers", aliases: ["snickers"], country: "US", parentCompany: "Mars" },
  { canonicalName: "Davidoff", aliases: ["davidoff coffee", "davidoff"], country: "DE", parentCompany: "Tchibo" },
  { canonicalName: "Palmolive", aliases: ["palmolive"], country: "US", parentCompany: "Colgate-Palmolive" },
  { canonicalName: "Nature Fresh", aliases: ["nature fresh", "naturefresh"], country: "US", parentCompany: "Cargill" },
  { canonicalName: "Bovonto", aliases: ["bovonto"], country: "IN", parentCompany: "Kali Aerated Water Works" },
  { canonicalName: "Storia", aliases: ["storia"], country: "IN" },
  { canonicalName: "Raw Pressery", aliases: ["raw pressery"], country: "IN" },
  { canonicalName: "Idhayam", aliases: ["idhayam"], country: "IN" },
  { canonicalName: "Eastern", aliases: ["eastern", "eastern masala"], country: "IN" },
  { canonicalName: "Aachi", aliases: ["aachi"], country: "IN" },
  { canonicalName: "Go", aliases: ["go cheese", "govardhan"], country: "IN", parentCompany: "Parag Milk Foods" },
  { canonicalName: "Chandrika", aliases: ["chandrika"], country: "IN" },
  // Fill batch 2 — notable additions
  { canonicalName: "Set Wet", aliases: ["set wet"], country: "IN", parentCompany: "Emami" },
  { canonicalName: "MyFitness", aliases: ["myfitness", "my fitness"], country: "IN" },
  { canonicalName: "Yoga Bar", aliases: ["yoga bar", "yogabar"], country: "IN", parentCompany: "ITC Limited" },
  { canonicalName: "24 Mantra", aliases: ["24 mantra", "24mantra"], country: "IN", parentCompany: "Organic India" },
  { canonicalName: "Disano", aliases: ["disano"], country: "IT", parentCompany: "Deoleo" },
  { canonicalName: "Dr. Oetker", aliases: ["dr oetker", "dr. oetker", "funfoods"], country: "DE", parentCompany: "Dr. Oetker GmbH" },
  { canonicalName: "Fun Foods", aliases: ["fun foods", "funfoods"], country: "DE", parentCompany: "Dr. Oetker GmbH" },
  { canonicalName: "McVitie's", aliases: ["mcvitie's", "mcvities", "mcvitie"], country: "GB", parentCompany: "pladis" },
  { canonicalName: "Himalayan Water", aliases: ["himalayan water", "himalayan"], country: "IN", parentCompany: "Tata Consumer Products" },
  { canonicalName: "Garnier", aliases: ["garnier"], country: "FR", parentCompany: "L'Oréal" },
  { canonicalName: "Boroline", aliases: ["boroline"], country: "IN", parentCompany: "GD Pharmaceuticals" },
  { canonicalName: "Ferrero Rocher", aliases: ["ferrero rocher", "ferrero"], country: "IT", parentCompany: "Ferrero Group" },
  { canonicalName: "Ching's Secret", aliases: ["ching's secret", "chings secret", "chings"], country: "IN", parentCompany: "Capital Foods" },
];
